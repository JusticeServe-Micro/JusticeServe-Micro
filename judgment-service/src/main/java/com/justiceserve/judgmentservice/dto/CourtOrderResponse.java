...
public class CourtOrderResponse {
    private Long orderId; private Long caseId; private Long judgeId;
    private String description; private LocalDate date; private CourtOrder.OrderStatus status;
    public static CourtOrderResponse from(CourtOrder o) {
        CourtOrderResponse r = new CourtOrderResponse();
        r.orderId=o.getOrderId(); r.caseId=o.getCaseId(); r.judgeId=o.getJudgeId();
