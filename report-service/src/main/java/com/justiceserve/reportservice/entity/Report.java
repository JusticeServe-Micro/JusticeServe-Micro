...
public class Report {
    ...
    @Enumerated(EnumType.STRING) @Column(nullable=false,length=15) private ReportScope scope;
    @Column(columnDefinition="TEXT") private String metrics;
    private LocalDate generatedDate;
    private Long generatedBy;
    @PrePersist public void prePersist() { this.generatedDate=LocalDate.now(); }
}